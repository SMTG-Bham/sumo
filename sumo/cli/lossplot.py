...
"""
A script to calculate and plot optical loss spectra from a VASP calculation.
"""
...
from sumo.plotting.optics_plotter import SLossPlotter
from sumo.electronic_structure.optics import (broaden_eps, calculate_loss,
                                              write_files)

__author__ = "Keith Butler"
__version__ = "1.0"
__maintainer__ = "?"
__email__ = ""
__date__ = "July 25, 2018"
...
def lossplot(filenames=None, prefix=None, directory=None,
    ...
    Args:
        filenames (:obj:`str` or :obj:`list`, optional): Path to vasprun.xml
            ...
            provided, in which case the loss spectra for each will be
        ...
        ymin (:obj:`float`, optional): The minimum loss intensity on the
            y-axis.
        ymax (:obj:`float`, optional): The maximum loss intensity on the
            y-axis.
    ...
    loss_data = [calculate_loss(d, average=average)
                for d in dielectrics]
...
def _get_parser():
    ...
    parser.add_argument('-l', '--labels', nargs='+', metavar='L',
                        help='labels for the loss specta')
...
def main():
    ...
    lossplot(filenames=args.filenames, prefix=args.prefix,
